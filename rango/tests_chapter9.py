...
class Chapter9RegistrationTests(TestCase):
    ...
    def test_registration_get_response(self):
        ...
        self.assertTrue('<h1>Register for Rango</h1>' in content,
                        f"{FAILURE_HEADER}We couldn't find the '<h1>Register for Rango</h1>' header tag in your register template. Did you follow the specification in the book to the leter?{FAILURE_FOOTER}")
